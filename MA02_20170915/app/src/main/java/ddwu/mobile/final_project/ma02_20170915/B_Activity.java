...
public class B_Activity extends Activity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        editSearch = findViewById(R.id.etBsearch);

        lvList = findViewById(R.id.lvBlog);

        //Blog
        resultList = new ArrayList();
        adapter = new BlogAdapter(this, R.layout.blog_list, resultList);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.btnBsearch:
                //사용자가 입력한 문자열에 '맛집'을 추가해서 쿼리를 만든다.
                query = editSearch.getText().toString() + " 맛집";
                try {
    ...
    class NaverAsyncTask extends AsyncTask<String, Integer, String> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            progressDlg = ProgressDialog.show(B_Activity.this, "Wait", "Downloading...");
        }
